		...
		if (is_array($co) ==  0 ){
			...
			if($_FILES['imgl']['name'] != null){
				if($_FILES['imgl']['type'] == "image/jpg" || $_FILES['imgl']['type'] == "image/jpeg" ){
					$sql = "INSERT INTO clientes (username, nombre, apellidos, correo, imagen,contra, tipo, ban) VALUES (:username, :nombres, :apellidos, :correo, :img,:contra, :tipo, 0)";
...
<section class="forms-section">
  ...
  <div class="forms">
    ...
    <div class="form-wrapper">
      ...
      <form class="form form-signup" action="inicio.php" method="POST" enctype="multipart/form-data">
        <fieldset>
          ...
          <div class="input-block">
            <label for="signup-password-confirm">comfirmar contraseña</label>
            <input name="confirm_password" id="signup-password-confirm" type="password" required>
          </div>
